...
class TestDictionaryWidget:
    """Tests for DictionaryWidget."""

    def test_creates_item_widget_for_each_dictionary_item(self, qapp: object) -> None:
    ...
    def test_passes_dictionary_values_to_item_widget_factory(self, qapp: object) -> None:
    ...
    def test_stores_item_widgets_by_dictionary_key(self, qapp: object) -> None:
    ...
    def test_creates_item_button_for_each_dictionary_item(self, qapp: object) -> None:
    ...
    def test_uses_string_representation_as_default_item_label(self, qapp: object) -> None:
    ...
    def test_uses_item_label_factory_for_button_labels(self, qapp: object) -> None:
    ...
    def test_item_widgets_are_added_to_stacked_widget(self, qapp: object) -> None:
    ...
    def test_show_item_displays_widget_for_given_key(self, qapp: object) -> None:
    ...
    def test_item_button_displays_associated_widget(self, qapp: object) -> None:
    ...
    def test_show_item_raises_key_error_for_unknown_key(self, qapp: object) -> None:
    ...
    def test_creates_empty_dictionary_widget(self, qapp: object) -> None:
